...
function Footer() {
    return(
        <footer>
            <h2 style={{textAlign: "center", fontSize: "20px"}}>Check out my socials, or email me here!</h2>
            <nav >
                <ul style={{margin: 40, position: "relative", bottom: 0}} className="footerNavbar">
                    ...
                    <li>
                        <a className="footerLink" href="mailto:ethan.cho1826@gmail.com"><i class="fas fa-envelope fa-5x footerIcon"></i></a>
                    </li>
                </ul>
            </nav>
        </footer>
